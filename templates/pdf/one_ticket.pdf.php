...
foreach ($ticket  as $tickets) {    
  ...
  //NAME MAX SIZE
    ...
    //TICKET PRICE TO FLOAT 2 PLACES
        ...
        $partly_paid ='<div style="font-size:11px;font-weight:bold;position:absolute; top:5mm; left:18mm; color:#F00">PAGO PARCIAL:00.00€</div>';
...
<page format="70x96" orientation="P" style="font: arial">
