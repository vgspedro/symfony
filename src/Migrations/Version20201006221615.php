 ...
 */
final class Version20201006221615 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE admin (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(100) NOT NULL, username VARCHAR(100) NOT NULL, password VARCHAR(64) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', status TINYINT(1) DEFAULT \'0\' NOT NULL, nif INT DEFAULT NULL, address LONGTEXT DEFAULT NULL, city LONGTEXT DEFAULT NULL, postal_code TINYTEXT DEFAULT NULL, phone LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_880E0D76E7927C74 (email), UNIQUE INDEX UNIQ_880E0D76F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE manager (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(100) NOT NULL, username VARCHAR(100) NOT NULL, password VARCHAR(64) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', status TINYINT(1) DEFAULT \'0\' NOT NULL, nif INT DEFAULT NULL, address LONGTEXT DEFAULT NULL, city LONGTEXT DEFAULT NULL, postal_code TINYTEXT DEFAULT NULL, phone LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_FA2425B9E7927C74 (email), UNIQUE INDEX UNIQ_FA2425B9F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE supplier (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(100) NOT NULL, username VARCHAR(100) NOT NULL, password VARCHAR(64) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', status TINYINT(1) DEFAULT \'0\' NOT NULL, nif INT DEFAULT NULL, address LONGTEXT DEFAULT NULL, city LONGTEXT DEFAULT NULL, postal_code TINYTEXT DEFAULT NULL, phone LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_9B2A6C7EE7927C74 (email), UNIQUE INDEX UNIQ_9B2A6C7EF85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE promocode CHANGE category_id category_id INT DEFAULT NULL, CHANGE discount_type discount_type ENUM(\'value\', \'percent\')');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking DROP promocode_name, DROP promocode_discount_amount, CHANGE client_id client_id INT DEFAULT NULL, CHANGE available_id available_id INT DEFAULT NULL, CHANGE stripe_payment_logs_id stripe_payment_logs_id INT DEFAULT NULL, CHANGE adult adult INT DEFAULT NULL, CHANGE children children INT DEFAULT NULL, CHANGE baby baby INT DEFAULT NULL, CHANGE status status VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE payment_status payment_status VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE promocode CHANGE category_id category_id INT DEFAULT NULL, CHANGE discount_type discount_type VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE rgpd CHANGE locales_id locales_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE staff CHANGE job_id job_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE stripe_payment_logs CHANGE booking_id booking_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE terms_conditions CHANGE locales_id locales_id INT DEFAULT NULL');
