 ...
 */
final class Version20200126205906 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking CHANGE adult adult INT DEFAULT NULL, CHANGE children children INT DEFAULT NULL, CHANGE baby baby INT DEFAULT NULL, CHANGE status status ENUM(\'pending\', \'canceled\', \'confirmed\'), CHANGE available_id available_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE stripe_payment_logs_id stripe_payment_logs_id INT DEFAULT NULL, CHANGE payment_status payment_status ENUM(\'incomplete\', \'canceled\', \'cleared\', \'completed\', \'denied\', \'failed\', \'held\', \'paid\', \'placed\', \'processing\', \'refunded\', \'refused\', \'removed\', \'returned\', \'reversed\', \'unclaimed\', \'approved\', \'canceled by user\', \'pending\', \'succeeded\', \'partial_refund\', \'uncaptured\'), ADD PRIMARY KEY (id)');
        ...
        $this->addSql('ALTER TABLE easytext ADD PRIMARY KEY (id)');
