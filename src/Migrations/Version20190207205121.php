 ...
 */
final class Version20190207205121 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking DROP category_id, CHANGE status status ENUM(\'pending\', \'canceled\', \'confirmed\')');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD category_id INT DEFAULT NULL, CHANGE status status VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
