 ...
 */
final class Version20200123195844 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE faqs (id INT AUTO_INCREMENT NOT NULL, locales_id INT DEFAULT NULL, html LONGTEXT NOT NULL, name LONGTEXT NOT NULL, INDEX IDX_8934BEE5164006B8 (locales_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE terms_conditions CHANGE name name LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE terms_conditions CHANGE name name VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
