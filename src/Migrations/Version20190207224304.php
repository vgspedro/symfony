 ...
 */
final class Version20190207224304 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_C74404553301C60 ON client');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C74404553301C60 ON client (booking_id)');
    }
}
