 ...
 */
final class Version20190715193057 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE feedback (id INT AUTO_INCREMENT NOT NULL, booking_id INT DEFAULT NULL, rate INT NOT NULL, observations LONGTEXT NOT NULL, INDEX IDX_D22944583301C60 (booking_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
