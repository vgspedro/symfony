 ...
 */
final class Version20190706150011 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE company ADD stripe_pk VARCHAR(255) DEFAULT NULL, ADD stripe_sk VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE company DROP stripe_pk, DROP stripe_sk');
