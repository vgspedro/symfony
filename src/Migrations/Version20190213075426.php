 ...
 */
final class Version20190213075426 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category ADD duration TIME DEFAULT \'00:00\' NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category DROP duration');
    }
}
