 ...
 */
final class Version20190308220838 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE company ADD country_id INT DEFAULT NULL, DROP country');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE company ADD country VARCHAR(20) NOT NULL COLLATE utf8mb4_unicode_ci, DROP country_id');
