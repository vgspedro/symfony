 ...
 */
final class Version20201006222211 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admin CHANGE nif nif INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE booking ADD promocode_code LONGTEXT DEFAULT NULL, DROP promocode_name, CHANGE available_id available_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE stripe_payment_logs_id stripe_payment_logs_id INT DEFAULT NULL, CHANGE adult adult INT DEFAULT NULL, CHANGE children children INT DEFAULT NULL, CHANGE baby baby INT DEFAULT NULL, CHANGE status status ENUM(\'pending\', \'canceled\', \'confirmed\'), CHANGE payment_status payment_status ENUM(\'incomplete\', \'canceled\', \'cleared\', \'completed\', \'denied\', \'failed\', \'held\', \'paid\', \'placed\', \'processing\', \'refunded\', \'refused\', \'removed\', \'returned\', \'reversed\', \'unclaimed\', \'approved\', \'canceled by user\', \'pending\', \'succeeded\', \'partial_refund\', \'uncaptured\'), CHANGE promocode_discount_amount promocode_discount_amount INT(11) UNSIGNED COMMENT "(DC2Type:money)" DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE manager CHANGE nif nif INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE supplier CHANGE nif nif INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD promocode_name LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP promocode_code, CHANGE client_id client_id INT DEFAULT NULL, CHANGE available_id available_id INT DEFAULT NULL, CHANGE stripe_payment_logs_id stripe_payment_logs_id INT DEFAULT NULL, CHANGE adult adult INT DEFAULT NULL, CHANGE children children INT DEFAULT NULL, CHANGE baby baby INT DEFAULT NULL, CHANGE status status VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE payment_status payment_status VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE promocode_discount_amount promocode_discount_amount INT(11) UNSIGNED COMMENT "(DC2Type:money)" DEFAULT \'NULL\'');
