 ...
 */
final class Version20190308211627 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE company ADD country VARCHAR(20) NOT NULL, ADD currency VARCHAR(20) DEFAULT NULL, DROP country_id, DROP currency_id');
