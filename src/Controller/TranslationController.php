...
class TranslationController extends AbstractController
{
    ...
    public function translate(Request $request) {
        ...
        $lang == 'en_EN' ? $response = array('lang' => $lang, 'data' => $this->translationEn()) : $response = array('lang' => $lang, 'data' => $this->translationPt());
...
private function translationPt(){
    ...
    'order' => 'Reserva Nº',
    'thank_you' => 'Em breve confirmaremos a sua reserva. Obrigado, Taruga Benagil Tours',
