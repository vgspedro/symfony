...
class OnlineController extends AbstractController
{
    ...
    public function index(Menu $menu, Stripe $stripe, Request $request, TranslatorInterface $translator)
    {
    ...
    **/
    ...
    public function refund(Menu $menu, Stripe $stripe, Request $request, TranslatorInterface $translator)
    {
        $this->denyAccessUnlessGranted('ROLE_ADMIN', null, 'Unable to access this page!');
